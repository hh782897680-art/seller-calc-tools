...
export default function MarkupCalculator() {
  ...
  return (
    ...
    >
      <InputField id="markup-cost" label="Cost" onChange={(value) => updateValue("cost", value)} prefix="$" placeholder={sampleValues.cost} value={values.cost} />
      <InputField id="markup-percent" label="Markup percentage" onChange={(value) => updateValue("markupPercentage", value)} suffix="%" placeholder={sampleValues.markupPercentage} value={values.markupPercentage} />
    </CalculatorWorkspace>
  );
}
